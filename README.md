...
本プロジェクトは独自の非営利・コピーレフトライセンスのもとで公開されています。
詳細は [LICENSE](./LICENSE) ファイルをご確認ください。

- **利用制限:** 非営利目的（個人利用・学習等）に限り、自由にご利用・改変いただけます。
- **商用利用:** 固く禁止します。
- **ソースコード公開:** 本コードを使用した派生ソフトウェアもソースコードの公開が必要です。
- **コントリビューション:** 機能追加や改善案がある場合は、IssueやPull Requestにてご相談いただけますと幸いです。
