...
if(!isReadOnly){try{__koeCache.clear()}catch(e){}} /* 書き込み後に古いキャッシュを返さない(プロフィール更新→再読込 など) */
const p=(async()=>{
...
p.then(()=>__koeInflight.delete(key),()=>__koeInflight.delete(key));
}
return p;
